...
module TomlFormatterModule
    def format(tomlFilePath)
        ...
        outputLines << "#   This file was generated by AnimationFileRelocator.exe\n"
        outputLines << "#   Every time you run this exe, this file will be deleted and re-generated.\n"
        outputLines << "# \n"
        ...
        outputLines << "# \n"
        outputLines << "#   If you want to run Hkanno.exe automatically, check my github page.\n"
